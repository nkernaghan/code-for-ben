...
| Category | Skills |
|----------|--------|
| **Workflow** | brainstorming, writing-plans, executing-plans, systematic-debugging, test-driven-development, verification-before-completion, dispatching-parallel-agents, subagent-driven-development, finishing-a-development-branch, using-git-worktrees, using-superpowers |
...
| **Trading** | quant_analyst |
| **DevOps** | devops-engineer, performance-optimizer |
| **Code Quality** | code-reviewer, reviewer, security_guard |
| **Other** | skill-creator, writing-skills, builder, orchestrator, automation_engineer, newsletter-builder, curriculum-architect, defuddle |
...
Slash commands: `/brainstorm`, `/build`, `/curriculum`, `/deploy`, `/docs`, `/newsletter`, `/optimize`, `/quant`, `/research`, `/review`, `/security`, `/ui`
